...
pub fn makeLib(lua: *Lua) i32 {
    ...
    text_surface = sdl.SDL_CreateRGBSurfaceFrom(text_gif.raw.ptr, @intCast(text_gif.width), @intCast(text_gif.height), @intCast(text_gif.channels * 8), // depth
        @intCast(text_gif.pitch), // pitch
        0x000000ff, // red mask
