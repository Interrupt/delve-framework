...
//
//    Cmdline:
//        sokol-shdc -i ../../assets/shaders/default.glsl -o graphics/shaders/default.glsl.zig -l glsl300es:glsl430:wgsl:metal_macos:metal_ios:metal_sim:hlsl4 -f sokol_zig --reflection
//
//    Overview:
//    =========
